...
public class ResponsiveServerMessage extends ResponsiveSidedMessage {

	public ResponsiveServerMessage() {
		this.name = "";
	...
	public ResponsiveServerMessage(String name, ResponsiveDataPacket dataPacket, BlockPos pos) {
		this.name = name;
